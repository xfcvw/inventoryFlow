const translations = {
    en: {
        ...
        // Interface completa / conteúdo dinâmico
        catalogEyebrow: 'CATALOG',
        masterData: 'MASTER DATA',
        stockControlLabel: 'STOCK CONTROL',
        salesLabel: 'SALES',
        crmLite: 'CRM LITE',
        analytics: 'ANALYTICS',
        rbac: 'RBAC',
        ...
        initialStock: 'Initial stock (default warehouse)',
        active: 'Active',
        yes: 'Yes',
        no: 'No',
        ...
        reportsRequirePaid: 'Reports require Pro or Business plan.',
        chooseReportPeriod: 'Choose a period and run the report.',
        units: 'units',
        noSalesPeriod: 'No sales in period.',
        remove: 'Remove',
        expires: 'expires',
        noPendingInvitations: 'No pending invitations.',
        inviteTeamMember: 'Invite team member',
        invitationSent: 'Invitation sent. Local link:',
        localBillingSimulator: 'Local billing simulator',
        localBillingDescription: 'No real money is charged. Plan limits are enforced so you can learn the SaaS architecture before connecting a payment provider.',
        unlimited: 'Unlimited',
        switchPlan: 'Switch plan',
        switchPlanConfirm: 'Switch workspace to {plan}? This is the local simulator and will not charge money.',
    ...
    pt: {
        ...
        logout: 'Sair',
        saasConnected: 'Empresa conectada ao SaaS',
        workspaceChanged: 'Empresa alterada.',
        workspaceSaved: 'Configurações da empresa salvas.',

        overview: 'VISÃO GERAL',
        dashboardTitle: 'Painel',
        dashboardSubtitle: 'Acompanhe a empresa selecionada.',
        ...
        productsSubtitle: 'Os produtos pertencem à empresa selecionada e ficam separados dos dados das outras empresas.',
        ...
        inventorySubtitle: 'Cada movimentação fica ligada à empresa e ao usuário que a realizou.',
        ...
        sales: 'VENDAS',
        ordersTitle: 'Pedidos',
        ordersSubtitle: 'Os pedidos ficam isolados dentro da empresa selecionada.',
        ...
        workspaceSettings: 'Configurações da Empresa',
        workspaceSettingsSubtitle: 'A empresa é o ambiente que separa seus dados dos dados de outras empresas.',
        generalSettings: 'Geral',
        generalSettingsSubtitle: 'Informações básicas da empresa selecionada.',
        workspaceSlug: 'Identificador da empresa',
        yourRole: 'Seu cargo',
        saveWorkspace: 'Salvar empresa',
        ...
        stockControlLabel: 'CONTROLE DE ESTOQUE',
        salesLabel: 'VENDAS',
        crmLite: 'CRM BÁSICO',
        analytics: 'ANÁLISES',
        ...
        productFormLabel: 'FORMULÁRIO DE PRODUTO',
        barcode: 'Código de barras',
        salePrice: 'Preço de venda',
        costPrice: 'Preço de custo',
        initialStock: 'Estoque inicial (depósito padrão)',
        active: 'Ativo',
        yes: 'Sim',
        no: 'Não',
        description: 'Descrição',
        orderBuilder: 'MONTAGEM DO PEDIDO',
        discount: 'Desconto',
        tax: 'Imposto',
        notes: 'Observações',
        addItem: '+ Item',
        ...
        selectProductShort: 'Selecionar produto',
        orderUpdated: 'Pedido atualizado.',
        reportsRequirePaid: 'Os relatórios estão disponíveis nos planos Pro e Empresarial.',
        chooseReportPeriod: 'Escolha um período e gere o relatório.',
        units: 'unidades',
        noSalesPeriod: 'Nenhuma venda no período.',
        remove: 'Remover',
        expires: 'expira em',
        noPendingInvitations: 'Nenhum convite pendente.',
        inviteTeamMember: 'Convidar membro da equipe',
        invitationSent: 'Convite enviado. Link local:',
        localBillingSimulator: 'Simulador local de cobrança',
        localBillingDescription: 'Nenhum valor real é cobrado. Os limites dos planos são aplicados para você aprender a arquitetura SaaS antes de conectar um provedor de pagamento.',
        unlimited: 'Ilimitado',
        switchPlan: 'Trocar plano',
        switchPlanConfirm: 'Trocar a empresa para o plano {plan}? Este é o simulador local e nenhum valor será cobrado.',
        ...
        system: 'Sistema',
        noAuditEntries: 'Nenhum registro de auditoria.',
        notification: 'Notificação',
        noNotifications: 'Nenhuma notificação.',
        deleteRecordConfirm: 'Excluir este registro?',
        subject: 'Objeto',
        metadata: 'Metadados',
        action: 'Ação',
